...
public class DemoConfiguration {
    ...
    static {
        addDemoFeature("user_identity", R.mipmap.cat, R.string.feature_sign_in_title,
                R.string.feature_sign_in_subtitle, R.string.feature_sign_in_overview,
                R.string.feature_sign_in_description, R.string.feature_sign_in_powered_by,R.mipmap.cat_pink,
                new DemoItem(R.string.main_fragment_title_user_identity, R.mipmap.user_identity,
                        R.string.feature_sign_in_demo_button, KnockList.class));
        addDemoFeature("push_notification", R.mipmap.push,
                ...
                R.string.feature_push_notifications_powered_by,R.mipmap.push_pink,
    ...
    private static void addDemoFeature(final String name, final int iconResId, final int titleResId,
                                       ...
                                       final int descriptionResId, final int poweredByResId, final int mainIconResId,
        ...
        demoFeature.poweredByResId = poweredByResId;
